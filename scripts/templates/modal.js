...
//form elements
const loginForm = document.querySelector(".form-elements");
...
loginForm.addEventListener('submit', (event)=> {
  ...
  const {first, last, email, message} = event.target.elements; // permet de sélectionner tous les éléments qui concernent firstname et lastname, aucun autre, c'est la destructuration
